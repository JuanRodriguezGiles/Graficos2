...
namespace engine
{
	...
	//	unsigned int colorLoc = glGetUniformLocation(_renderer->shader.ID, "color");
	//	glUniform3fv(colorLoc, 1, glm::value_ptr(newColor));
	//
	//	unsigned int alphaLoc = glGetUniformLocation(_renderer->shader.ID, "a");
	//	glUniform1fv(alphaLoc, 1, &(color.a));
	//
	//	unsigned int textureLoc = glGetUniformLocation(_renderer->shader.ID, "ourTexture");
